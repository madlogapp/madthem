...
const MAD_DATA = [
  ...
  /* ===== 提供分（第3弾・単体MAD） ===== */
  {
    ...
    reading: "こえのかたち",
    genres: ["ロック"],
    youtubeId: "1i5FKx6r4-I",
    duration: "4:12",
    year: 2024,
    hot: true,
    recommended: true,
    description:
      "RADWIMPS「有心論」に乗せた『聲の形』単体MAD。二つの神様という副題どおり、贖罪と赦しの距離を丁寧に描く。",
    tags: ["聲の形", "有心論", "RADWIMPS"],
  },
  {
    id: "m036",
    title: "魔法鏡",
    ...
    recommended: true,
    description:
      "RADWIMPS「魔法鏡」に乗せた『エヴァンゲリオン』単体MAD。鏡像のモチーフと心象風景が重なる構成。",
    tags: ["エヴァンゲリオン", "エヴァ", "魔法鏡", "RADWIMPS"],
  },
  {
    id: "m037",
    title: "会心の一撃",
    ...
    reading: "はいきゅー",
    genres: ["ロック"],
    youtubeId: "zs8uW_8R2BQ",
    duration: "4:35",
    year: 2024,
    hot: true,
    recommended: true,
    description:
      "RADWIMPS「会心の一撃」に乗せた『ハイキュー!! TO THE TOP』稲荷崎戦の単体MAD。逆転の一打にサビが刺さる。",
    tags: ["ハイキュー!!", "ハイキュー", "稲荷崎", "会心の一撃", "RADWIMPS"],
  },
  {
    id: "m038",
    title: "ロウワー",
    ...
    recommended: true,
    description:
      "Vaundy「ロウワー」に乗せた『ブルーロック』単体MAD。エゴの衝突と疾走をビートに同期させた一次選考編。",
    tags: ["ブルーロック", "ロウワー", "Vaundy"],
  },
  {
    id: "m039",
    title: "正解",
    ...
    reading: "はいきゅー",
    genres: ["ロック"],
    youtubeId: "MjRfG3hKVKM",
    duration: "6:00",
    year: 2024,
    hot: false,
    recommended: true,
    description:
      "RADWIMPS「正解」に乗せた『ハイキュー!!』単体MAD。答えのない問いに挑む青春をじっくり編んだ大作。",
    tags: ["ハイキュー!!", "ハイキュー", "正解", "RADWIMPS"],
  },
  {
    id: "m040",
    title: "祝福",
    ...
    recommended: true,
    description:
      "YOASOBI「祝福」に乗せた『リコリス・リコイル』単体MAD。日常と銃声の対比を軽やかなビートで繋ぐ。",
    tags: ["リコリス・リコイル", "リコリコ", "祝福", "YOASOBI"],
  },
  {
    id: "m041",
    title: "勇者",
    ...
    reading: "そうそうのふりーれん",
    genres: ["J-POP"],
    youtubeId: "2pCQEUPcgug",
    duration: "3:14",
    year: 2024,
    hot: true,
    recommended: true,
    description:
      "YOASOBI「勇者」（フリーレンOP）に乗せた『葬送のフリーレン』単体MAD。旅路の余韻を歌詞と同期させる。",
    tags: ["葬送のフリーレン", "勇者", "YOASOBI"],
  },
  {
    id: "m042",
    title: "晴る",
    ...
    recommended: true,
    description:
      "ヨルシカ「晴る」に乗せた『葬送のフリーレン』単体MAD。軽やかなオルタナロックに旅情が重なる。",
    tags: ["葬送のフリーレン", "晴る", "ヨルシカ"],
  },
  {
    id: "m043",
    title: "セブンティーン",
    ...
    reading: "おしのこ",
    genres: ["J-POP"],
    youtubeId: "SLSBAngQPg4",
    duration: "3:26",
    year: 2024,
    hot: true,
    recommended: true,
    description:
      "YOASOBI楽曲に乗せた『【推しの子】』単体MAD。光と影のアイドル像をテンポよく編集（英語字幕付き）。",
    tags: ["推しの子", "セブンティーン", "YOASOBI"],
  },
  {
    id: "m044",
    title: "もう一度",
    ...
    reading: "おしのこ",
    genres: ["J-POP"],
    youtubeId: "Ma9qwoTsFYQ",
    duration: "4:33",
    year: 2024,
    hot: false,
    recommended: false,
    description:
      "Tani Yuuki「もう一度」に乗せた『【推しの子】』単体MAD（完結記念作品）。物語の軌跡を振り返る構成。",
    tags: ["推しの子", "もう一度", "Tani Yuuki"],
  },
  {
    id: "m045",
    title: "メフィスト",
    ...
    reading: "おしのこ",
    genres: ["ロック"],
    youtubeId: "vIKGFjBSAQE",
    duration: "3:45",
    year: 2024,
    hot: true,
    recommended: true,
    description:
      "女王蜂「メフィスト」（第2期OP）に乗せた『【推しの子】』単体MAD。妖しくドラマチックな世界観が映える。",
    tags: ["推しの子", "メフィスト", "女王蜂"],
  },
  {
    id: "m046",
    ...
    reading: "きみのなは",
    genres: ["ロック"],
    youtubeId: "dg7XcUMrjg0",
    duration: "5:51",
    year: 2024,
    hot: false,
    recommended: true,
    description:
      "RADWIMPS「告白」に乗せた『君の名は。』単体MAD。すれ違いと邂逅の物語を叙情的に紡ぐ。",
    tags: ["君の名は。", "告白", "RADWIMPS"],
  },
];
